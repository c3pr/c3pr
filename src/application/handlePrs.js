...
async function handlePrs(prs) {
    c3prLOG(`Handling PR request title '${prs.repository.revision}' rev '${prs.repository.revision}'`, {prs}, {nodeName: 'c3pr-repo-gitlab', correlationId: prs.meta.correlationId, moduleName: 'handlePrs'});
    ...
    c3prLOG(`PR created successfully.`, {nodeName: 'c3pr-repo-gitlab', correlationId: prs.meta.correlationId, moduleName: 'handlePrs'});
}
