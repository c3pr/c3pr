...
function emitChangesCommitted(changesCommitted, {lcid, euuid}) {
    ...
    c3prLOG4(
        ...
        {lcid, euuid, meta: {payload: changesCommitted}}
    );
    ...
    return c3prRNE.registerNewEvent({
        ...
        c3prLOG4(`Error while registering new event: ChangesCommitted.`, {lcid, euuid, error});
    });
}
