...
(() => {
    ...
    newPR({projectUUID: "7ac33816-c794-4cf3-a5b4-5f7e2ff06543", url: "http://example.com/starwars/c-3po-project/pull/1", ToolInvocationCompleted: "...", changed_files: ["a1.txt"]});
    // noinspection JSIgnoredPromiseFromCall
    newPR({projectUUID: "7ac33816-c794-4cf3-a5b4-5f7e2ff06543", url: "http://example.com/starwars/c-3po-project/pull/2", ToolInvocationCompleted: "...", changed_files: ["a2.txt"]}); //later status:merged
    // noinspection JSIgnoredPromiseFromCall
    newPR({projectUUID: "7ac33816-c794-4cf3-a5b4-5f7e2ff06543", url: "http://example.com/starwars/c-3po-project/pull/3", ToolInvocationCompleted: "...", changed_files: ["a3.txt"]}); //later status:closed
});
