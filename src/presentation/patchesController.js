...
module.exports = function (app) {
    ...
    app.post('/patches', function (request, response) {
        ...
        if (!patches.meta ||
            ...
            c3prLOG(errorMessage, {patches}, {nodeName: 'c3pr-brain', correlationIds: [patches.meta && patches.meta.correlationId], moduleName: 'patchesController'});
            response.status(400).send(errorMessage);
            return;
        }
        c3prLOG(`Patches received. Tool: ${patches.tool.toolId}; Title: ${patches.patch.title}`, {patches}, {nodeName: 'c3pr-brain', correlationId: patches.meta.correlationId, moduleName: 'patchesController'});
