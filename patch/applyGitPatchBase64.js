...
async function applyGitPatchBase64(cloneFolder, gitUserName, gitUserEmail, patch, { ids }) {
    ...
    await c3prSH3_1.default(`git -c user.name='${userNameNoQuotes}' -c user.email='${userEmailNoQuotes}' am --keep-cr --whitespace=fix ${patchFileName}`, { cwd: cloneFolder }, { ids });
