...
async function updatePrOfProject(project_uuid, pr_id, status, assignee) {
    let { data } = await axios_1.default.post(__1.hubClientConfig.c3pr.hub.prOfProjectUrl(project_uuid, pr_id), { status, assignee }, { headers: __1.hubClientConfig.headers() });
    return data;
}
